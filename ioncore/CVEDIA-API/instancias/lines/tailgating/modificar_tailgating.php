...
if (!(
    $instanceId
        && $lineId
        && (($coordinates && $classes && $direction && $color && $seconds) || $attribute_restrictions)
)) {
    Utils::acabarRequest([]);
}
...
$crossing_lines = $l->obtener_lines_full($instanceId)["crossingLines"] ?? [];
