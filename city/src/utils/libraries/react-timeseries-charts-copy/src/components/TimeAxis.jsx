...
export default class TimeAxis extends React.Component {
    ...
    renderTimeAxis(scale, format, showGrid, gridHeight) {
        ...
        const tickSize = showGrid ? -gridHeight : 16; //modificado (por defecto: 10)
        ...
        const node = document.getElementById("gTimeAxisIdMod") //modificado. Se ha quitado findDOMNode en react 19.0.0
