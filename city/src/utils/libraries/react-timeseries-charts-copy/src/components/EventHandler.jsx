...
export default class EventHandler extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            permitirScroll: false //modificado
        };
    ...
    handleMouseDown(e) {
        ...
        if (e.button === 2) {
            //modificado
            this.setState({permitirScroll:true});
            if(this.props.setScrolling){
    ...
    handleMouseUp(e) {
        ...
        //modificado
        this.setState({permitirScroll:false});
        if(this.props.setScrolling){
            setTimeout(() => {
    ...
    handleMouseMove(e) {
        ...
        if (this.state.isPanning) {
            if(this.state.permitirScroll){ //modificado
