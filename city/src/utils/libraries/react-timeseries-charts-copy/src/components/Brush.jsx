 ...
 * 
 * modificado para controlar si se está seleccionando(prop setSeleccionando)
 * al mouse down no lo pongo. eso se puede controlar desde fuera cuando cambia la selección
 */
export default class Brush extends React.Component {
    ...
    handleBrushMouseDown(e) {
        ...
        //modificado
        if(this.props.setSeleccionando){
            this.props.setSeleccionando(true)
        }
    }

    handleOverlayMouseDown(e) {
        e.preventDefault();
        if(e.button !==2){ //modificado
    ...
    handleMouseUp(e) {
        ...
        //modificado
        if(this.props.setSeleccionando){
            this.props.setSeleccionando(false)
        }
    }
