...
import { EcoLabels } from "./Components/EcoLabels"
...
export const MobilityStats = () => {
    ...
    //Loading
    const [loadingsControl, setLoadingsControl] = useState({ 'traffic': true, 'nationality': true, 'vehicleTypes': true, 'ecoLabels': true, 'alerts': true})
        ...
        <>
            ...
            <main className={styles['wrapper']}>
                ...
                <section className={styles['left__section']}>
                    <Box routes={[{ name: t('sections.ESTADISTICAS') }, { name: t('titles.vehicles') }]}>
                        ...
                        <div className={styles['grid']}>
                            <div className={styles['graph100']}>
                                <Traffic preset={preset?.cod} payload={payload} device={selectedDevice} setLoadingsControl={setLoadingsControl} />
                            </div>
                            <div className={styles['graph100']}>
                                <EcoLabels preset={preset?.cod} payload={payload} device={selectedDevice} setLoadingsControl={setLoadingsControl} />
                            </div>
                             <div className={styles['graph']}>
                                <VehicleTypes preset={preset?.cod} payload={payload} device={selectedDevice} setLoadingsControl={setLoadingsControl} />
                            </div>
                            <div className={styles['graph']}>
                                <Nationality preset={preset?.cod} payload={payload} device={selectedDevice} setLoadingsControl={setLoadingsControl} />
                            </div>
                        </div>
                ...
                <section className={styles['right__section']}>
                    <div>
                        <h2 className={styles['right__section__title']}>{t('titles.peopleMobility')}</h2>
                        ...
                        <Alerts preset={preset2?.cod} payload={payload2} device={selectedDevice2} setLoadingsControl={setLoadingsControl} order={selectedOrder?.cod} />
                    </div>
