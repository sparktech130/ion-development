...
export const TransportedPassengers = ({
    ...
    const getData = async () => {
        ...
        let error = true
        setLoadingsControl(prev => ({ ...(prev || {}), 'transported': true }))
        ...
        try {
            ...
            setTimeout(() => {
                ...
                setLoadingsControl(prev => ({ ...(prev || {}), 'transported': false }))
            }, 300);
        }
    }
    ...
    return (
        <>
            ...
            <StatsCard
                title={t('titles.transportedPassengers')}
