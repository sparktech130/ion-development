...
export const AlertsInsurance = ({
    ...
    const getData = async () => {
        ...
        setLoadingsControl(prev => ({ ...(prev || {}), 'alertsInsurance': true }))
        ...
        try {
            ...
            setTimeout(() => {
                setLoadingsControl(prev => ({ ...(prev || {}), 'alertsInsurance': false }))
            }, 300);
        }
    }
    ...
    return (
        <>
            ...
            <StatsCard
                title={t('titles.insuranceCampaignAlerts')}
                description={[(media || 0) + ' ' + t('terms.alerts') + ' / ' + (groupDays ? t('terms.day') : t('terms.hour'))]}
