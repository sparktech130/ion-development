...
export const RecognitionsInsurance = ({
    ...
    const getData = async () => {
        ...
        setLoadingsControl(prev => ({ ...(prev || {}), 'recognitionsInsurance': true }))
        ...
        try {
            ...
            setTimeout(() => {
                setLoadingsControl(prev => ({ ...(prev || {}), 'recognitionsInsurance': false }))
            }, 300);
        }
    }
    ...
    return (
        <>
            ...
            <StatsCard
                title={t('titles.insuranceCampaignRecognitions')}
