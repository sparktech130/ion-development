...
export const RecognitionsItv = ({
    ...
    const getData = async () => {
        ...
        setLoadingsControl(prev => ({ ...(prev || {}), 'recognitionsItv': true }))
        ...
        try {
            ...
            setTimeout(() => {
                setLoadingsControl(prev => ({ ...(prev || {}), 'recognitionsItv': false }))
            }, 300);
        }
    }
    ...
    return (
        <>
            ...
            <StatsCard
                title={t('titles.itvCampaignRecognitions')}
