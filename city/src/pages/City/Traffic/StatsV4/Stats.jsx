...
export const Stats = () => {
    ...
    //Loading
    const [loadingsControl, setLoadingsControl] = useState({ 'traffic': true, 'speed': true, 'vehicleTypes': true, 'nationality': true, 'alerts': true })
    ...
    const autocompletes = { autocompleteLists, setAutocompleteLists }
            ...
            <main className={styles['wrapper']}>
                    ...
                    <Box routes={[{ name: t('sections.ESTADISTICAS') }]}>
                        ...
                        <div className={styles['grid']}>
                            <div className={styles['graph100']}>
                                <Traffic preset={preset?.cod} payload={payload} device={selectedDevice} autocompletes={autocompletes} setLoadingsControl={setLoadingsControl} />
                            </div>
                            <div className={styles['graph100']}>
                                <Speed preset={preset?.cod} payload={payload} device={selectedDevice} autocompletes={autocompletes} setLoadingsControl={setLoadingsControl} />
                            </div>
                            <div className={styles['graph']}>
                                <VehicleTypes preset={preset?.cod} payload={payload} device={selectedDevice} autocompletes={autocompletes} setLoadingsControl={setLoadingsControl} />
                            </div>
                            <div className={styles['graph']}>
                                <Nationality preset={preset?.cod} payload={payload} device={selectedDevice} autocompletes={autocompletes} setLoadingsControl={setLoadingsControl} />
                            </div>
                        </div>
                ...
                <section className={styles['right__section']}>
                    <div>
                        ...
                        <Alerts preset={preset2?.cod} payload={payload2} device={selectedDevice2} autocompletes={autocompletes} setLoadingsControl={setLoadingsControl} order={selectedOrder?.cod} />
