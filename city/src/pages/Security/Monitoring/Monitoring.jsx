...
export const Monitoring = () => {
    ...
    return (
        <>
            {currentServer ?
                <CurrentServer currentServer={currentServer} setCurrentServer={setCurrentServer} />
            : 
                <>
                    ...
                    <main className={styles['wrapper']}>
                        ...
                        <section className={styles['left__section']}>
                            <Box routes={[{ name: t('sections.MONITORIZACION') }]}>
                                ...
                                <div className={styles['grid']}>
                                    <Users setLoadingsControl={setLoadingsControl} />
                                    <Conexions setLoadingsControl={setLoadingsControl} />
                                    <Servers setCurrentServer={setCurrentServer} setLoadingsControl={setLoadingsControl} />
                                </div>
                        ...
                        <section className={styles['right__section']}>
                            <div>
                                <h2 className={styles['right__section__title']}>{t('titles.vulnerabilities')}</h2>
